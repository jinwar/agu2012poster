\documentclass[paperwidth=65in,paperheight=43in,landscape,final,fontscale=0.30]{baposter}
...
%  background=shade-tb,
 ...
 Imaging Crust and Mantle Structure beneath the D'Entrecasteaux Islands from Rayleigh Wave Tomography
  ...
  {\large AGU 2012 Fall Meeting:\textbf{T43E-2719} Contact Email: ge.jin@ldeo.columbia.edu}
	...
	\columnbreak
	\begin{flushright}
		\includegraphics[height=5ex]{pics/ldeologo}
	\end{flushright}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Data}{name=data,column=1,span=1,below=introduction,above = bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


Ambient Noise Ray Coverage

\includegraphics[width=0.50\linewidth]{pics/topo/raycover} 

Bessel Function Fitting

\begin{tabular}{@{}c@{ }c@{ }c@{ }c@{}@{ }@{ }c@{ }c@{ }c@{ }c@{ }}
	\includegraphics[width=0.60\linewidth]{pics/besselfit/besselfitwaveform} & 
	\includegraphics[width=0.26\linewidth]{pics/besselfit/besselfitphv} 
\end{tabular}

Earthquake Distribution

\includegraphics[width=0.60\linewidth]{pics/eqlocation/eqloc}

Five Parameter Wavelet fitting

	\includegraphics[width=0.60\linewidth]{pics/gsdffit/gsdfwaveletfit} 
  }

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Method}{name=method,column=0,span=1,below=introduction}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent\textbf{\large Ambient Noise}

Because short intra-station distance violate the far-field estimation of time-domain ambient noise method, we applied the original Aki's spectral formulation which was further developed by Esktr\"{o}m et al., 2009. The key result of these papers can be presented as equation~\ref{eqn:aki}:
\begin{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Reference}{name=ref,column=0,span=1,below=method,above = bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

  }

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Rayleigh Wave Phase Velocity}{name=results,column=2,span=2,row=0}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \begin{center}

	  Ambient Noise Ray Theory Tomography

	  \begin{tabular}{@{}c@{ }c@{ }c@{ }c@{}@{ }@{ }c@{ }c@{ }c@{ }c@{ }}
		\includegraphics[width=0.18\linewidth]{pics/noiseray/phasev_20}&
		\includegraphics[width=0.18\linewidth]{pics/noiseray/phasev_14}&
		\includegraphics[width=0.18\linewidth]{pics/noiseray/phasev_09}&
		\includegraphics[width=0.18\linewidth]{pics/noiseray/phasev_05}&
		\includegraphics[width=0.18\linewidth]{pics/noiseray/phasev_03}\\
		 6.6s &  8.7s  &   11.6s &   15.8s & 19.4s \\[0.8em]
	  \end{tabular}

	  Teleseismic Eikonal Tomography

	  \begin{tabular}{@{}c@{ }c@{ }c@{ }c@{}@{ }@{ }c@{ }c@{ }c@{ }c@{ }}
		\includegraphics[width=0.18\linewidth]{pics/eq/eqeikonal_0}&
		\includegraphics[width=0.18\linewidth]{pics/eq/eqeikonal_1}&
		\includegraphics[width=0.18\linewidth]{pics/eq/eqeikonal_2}&
		\includegraphics[width=0.18\linewidth]{pics/eq/eqeikonal_3}&
		\includegraphics[width=0.18\linewidth]{pics/eq/eqeikonal_4}\\
		 20s &  25s  &   32s &  40s &  50s\\[0.8em]
	  \end{tabular}
  \end{center}
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{1D Shear Velocity Inversion}{name=dispinv,column=2,span=1,above=bottom,below=results}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{multicols}{2}
	\includegraphics[width=0.90\linewidth]{pics/topo/regionmarker} 

	\columnbreak

	In this study, we applied the 1D shear velocity model for the average dispersion curve of two typical regions. In the figure to the left, the red circle centering at Goodenough Island, illustrates the area on the rift extension.

\end{multicols}
%  \begin{center}
	  \begin{tabular}{@{}c@{ }c@{ }c@{ }c@{}@{ }@{ }c@{ }c@{ }c@{ }c@{ }}
		\includegraphics[height=0.40\linewidth]{pics/dispinv/island_mainland_mod} &
		\includegraphics[height=0.40\linewidth]{pics/dispinv/island_mainland_dispfit} 
	  \end{tabular}
%  \end{center}
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Conclusion}{name=conclusion,column=3,span=1,above=bottom,below=results}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \smaller 
  }%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
